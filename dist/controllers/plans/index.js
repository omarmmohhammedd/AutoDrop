...
class PlansController extends baseApi_1.default {
    ...
    async UpdatePlan(req, res, next) {
        try {
            ...
            plan.save(async (err, result) => {
                ...
                super.send(res, "Plan updated successfully");
            });
        }
        catch (error) {
            next(error);
    ...
    async GetAllPlans(req, res, next) {
        try {
            ...
            super.send(res, { plans });
        }
        catch (error) {
            next(error);
        }
    }
    async GetSelectedPlan(req, res, next) {
        try {
    ...
    async Resubscribe(req, res, next) {
        try {
            ...
            return super.send(res, "Your plan has been upgraded successfully!!");
        }
        catch (error) {
            next(error);
        }
    ...
    async GetAllSubscriptions(req, res, next) {
        try {
            ...
            super.send(res, { subscriptions });
        }
        catch (error) {
            next(error);
        }
    }
    async GetPlanAndVendorTransactions(req, res, next) {
        try {
    ...
    async DeletePlan(req, res, next) {
        try {
            ...
            await plan.delete();
            super.send(res, "Plan deleted successfully!");
        }
        catch (error) {
            next(error);
        }
...
function GenerateChargePayment(req, id, user_id) {
    return new Promise(async (resolve, reject) => {
        ...
        console.log(customerSendToPayment);
...
_a = new PlansController(), exports.CreatePlan = _a.CreatePlan, exports.UpdatePlan = _a.UpdatePlan, exports.GetAllPlans = _a.GetAllPlans, exports.GetSelectedPlan = _a.GetSelectedPlan, exports.CreatePaymentToSubscribe = _a.CreatePaymentToSubscribe, exports.Resubscribe = _a.Resubscribe, exports.GetAllSubscriptions = _a.GetAllSubscriptions, exports.GetPlanAndVendorTransactions = _a.GetPlanAndVendorTransactions, exports.DeletePlan = _a.DeletePlan;
