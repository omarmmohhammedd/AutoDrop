...
class SubscriptionController extends baseApi_1.default {
    async CheckSubscription(user, key) {
...
exports.CheckSubscription = new SubscriptionController().CheckSubscription;
